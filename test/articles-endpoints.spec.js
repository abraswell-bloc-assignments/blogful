...
// RUN psql -U dunder_mifflin -d blogful-test -f ./migrations/001.do.create_blogful_articles.sql
// AND ALSO RUN psql -U dunder_mifflin -d blogful-test -f ./migrations/002.do.alter_article_style.sql
